...
# Acknowledgments
We thank Annie Snyder, Frederico San Martini, Kevin Koy, Tina Birmpili, Elina Yuen, Alejandro Ramirez-Pabon, and Nick Gondek. Additionally, we thank valued community members as listed at https://kigalisim.org/humans.txt as well as national ozone units and workshop participants who engaged with the tool during its development. We also thank the developers of our runtime dependencies [@aceeditor; @antlr; @apachecsv; @chartjs; @d3; @papaparse; @prism; @qunit; @tabby; @webpack; @teavm]. Project of The Eric and Wendy Schmidt Center for Data Science and the Environment at UC Berkeley undertaken with input from the Multilateral Fund. No conflicts of interest to disclose. AI assistants used with constrained tasks and strict human review [@claude_ai; @copilot; @intellij_ai; @replit_ai].
