...
**Note that this is the AI version of this tutorial.** You can find a version of this tutorial without AI at [Tutorial 6](https://kigalisim.org/guide/tutorial_06.html).
...
```
Great! Here's what I would like:

 - 20% recovery.
 - 90% reuse.
 - Recycle at point of servicing (recharge).
 - 0% induced demand.

Let's have this start in year 2027 and continue to the end of the simulation.

Let's call this policy Domestic Recycling. Please also add a new simulation alongside BAU and Permit called Recycling with this new Domestic Recycling policy included.
```
