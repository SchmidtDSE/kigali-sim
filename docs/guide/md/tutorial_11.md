...
```
Hello! Please review https://kigalisim.org/llms.txt?v=20260128 and https://preview.kigalisim.org/llms-full.txt?v=20260128. Then, we will build a simulation together.
```
