...
```
Hello! Please review https://preview.kigalisim.org/llms-full.txt?v=20260302. Then, we will build a simulation together. Please be sure to include the simulation stanza like seen in https://kigalisim.org/guide/tutorial_02.qta.
```
...
```
Hello! Please review https://preview.kigalisim.org/llms-full.txt?v=20260302. Then, we will build a simulation together.
```

**Note**: You may want to review the [assistants](#assistants) section for tips on making your specific AI assistant work well. Also, the use of the version (v=20260302) is optional but we recommend it to ensure you have the latest copy.
