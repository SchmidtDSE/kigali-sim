...
**Note that this is the conventional version of this tutorial.** An AI-assisted alternative is available at [Tutorial 6a](https://kigalisim.org/guide/tutorial_06a.html).
